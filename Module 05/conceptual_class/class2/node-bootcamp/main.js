...
const changeTemplate=require('./modules/changeTemplate')
...
const server=http.createServer((req,res)=>{
   ...
   const {query,pathname}= url.parse(req.url,true)
    ...
    if(pathname==="/"|| pathname==="/overview"){
      ...
      const cardsHtml=  dataObj.map(el=>changeTemplate(tempCard,el)).join('');
     ...
     //   Product Page
      ...
      const output=changeTemplate(tempProduct,product)
